...
function Channels() {
    ...
    const itemTemplate = (product) => {
        ...
        if (activeIndex === 0) return listItem(product);
        // else if (activeIndex === 1) return gridItem(product, );
    };
    ...
    return (
        <>
            ...
            <div className='globalContainer'>
                <AddEvent />
                <DataView value={ channels.filter((i) => i.is_personal === false) } itemTemplate={itemTemplate} />
            </div>
        </>
    )
